...
def generate_launch_description():
    ...
    param_file_cmd = DeclareLaunchArgument(
        'param_file', default_value='./jetbot_tools/param/tf2_follow_copilot_params.yaml')
    

    # Start the ROS2 node with tf2 lookup for the GoPiGo3/Jetbot two wheel bot.
    start_detect_copilot_node_cmd = Node(
        package='jetbot_tools',
        executable='tf2_follow',
        output="screen",
